...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="min-h-screen pb-16" style={{ background: "#faf6ee" }}>
      {/* Header */}
      <header className="dark-surface border-b" style={{ background: "#0a2112", borderColor: "rgba(255,255,255,0.08)" }}>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 border-b border-gray-200 pb-4 mt-6">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="yellow-button px-4 py-2 text-xs font-black uppercase tracking-wider rounded-xl transition-all shadow-xs hover:-translate-y-0.5"
          ...
          <form onSubmit={handleSearchSubmit}>
            ...
            <div className="flex justify-end gap-3 mt-4 pt-4 border-t border-gray-100">
              ...
              <button
                ...
                className="dark-surface px-6 py-2 rounded-lg text-xs font-black uppercase tracking-wider text-white transition-all hover:bg-green-800 disabled:opacity-50"
